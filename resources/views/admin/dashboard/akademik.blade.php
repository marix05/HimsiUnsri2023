...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <a class="btn btn-primary" href="{{ route('insert-akademik') }}"><i class="fa fa-plus"></i> Create New Post</a>
        </div>
        <div class="card-body">
                    ...
                    <tbody>
                        ...
                        @foreach($posts as $post)
                            <tr>
                                ...
                                <td>{{ date('d F Y', strtotime($post['expDate'])) }}</td>
                                <td>{{ $post["author"] }}</td>
                                <td>
                                    <a class="btn btn-md btn-warning" href="{{ route('update-akademik', $post['postID']) }}"><i class="fa fa-pen"></i> Edit</a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                            <h4 class="modal-title">Delete Artikel Akademik</h4>
